            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    @auth
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('wallet.withdraw.form') }}">Withdraw</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('wallet.transfer.form') }}">Transfer</a>
                        </li>
    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div id="sidebar" class="col-md-3 col-lg-2 bg-light p-3 border-end">
                ...
                <h5 class="mb-3">Features</h5>
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link" href="{{ route('wallet.show') }}"><i
                                class="bi bi-house"></i> Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('wallet.withdraw.form') }}"><i
                                class="bi bi-wallet"></i> Withdraw</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('wallet.transfer.form') }}"><i
                                class="bi bi-arrow-left-right"></i> Transfer</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('chat.index') }}"><i
                                class="bi bi-chat-dots"></i> Customer Care</a></li>

                    <li class="nav-item"><a class="nav-link" href="{{ route('giftcards.index') }}"><i
                                class="bi bi-gift"></i> Giftcards</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('giftcards.my-bids') }}"><i
                                class="bi bi-basket"></i> My Bids</a></li>
